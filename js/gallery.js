...
// ---------- Images list (now empty) ----------
// Removed the large embedded static list so the gallery becomes fully automatic.
// At runtime the script will prefer /images.json (generated by CI), then try the
// GitHub Contents API, and finally fall back to an empty gallery if neither is available.
let imagesList = [];
